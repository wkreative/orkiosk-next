...
import { Save, ArrowLeft, Loader2, Hash, Eye, Globe } from 'lucide-react';
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">Crea una nueva página para tu sitio</p>
                        </div>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Ubicación y Horarios"
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <input
                                            ...
                                            placeholder="ubicacion-horarios"
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="Ej: ubicación orkiosk"
